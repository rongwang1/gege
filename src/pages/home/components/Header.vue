        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="CV档案" name="first">
            <div class="head">
              <div class="head-img">
                <img
                  src="//static.missevan.com/seiys/201604/556eb6ac9553e75d0fd8bee5148238bf182357.jpg"
                  alt="#"
                />
              </div>
              <div class="info">
                <h1 class="info-title">
                  风华无双
                  <a
                    href="http://weibo.com/fenghuawushuang"
                    class="iconfont sina"
                    target="_blank"
                  >
                    <i>&#xe716;</i>
                  ...
                  <a
                    href="http://baike.baidu.com/view/3293213.htm"
                    class="iconfont baidu"
                    target="_blank"
                  >
                    <i>&#xe846;</i>
                  </a>
            ...
            <div class="content">
              <div class="basic-info">
                ...
                <p
                  class="intro"
                >怀旧配音联盟CV，微博：@明玥无双。代表作品：《青龙图腾》《乱世为王》《艳鬼》《民国遗事1931》《琅琊榜》《暮云深》《剑在天下》《结发》《独闯天涯》《给我一碗小米粥》</p>
              </div>
          ...
          <el-tab-pane label="其他" name="third">
            <home-card :comment="comment"></home-card>
          </el-tab-pane>
        </el-tabs>
      </el-col>
    </el-row>
